...
# ============ CONFIGURATION ============
INPUT_FILE = "/mfs1/u/chuning/scale_new/performance_by_compute_gap.csv"
OUTPUT_FILE = "/mfs1/u/chuning/scale_new/performance_by_compute_gap_plot"
...
ax_left.set_xlabel("Compute Gap \n $ = {\mathrm{Greatest Heldout LLM Run}}/{\mathrm{Greatest Training LLM Run}}$", fontweight='bold')
