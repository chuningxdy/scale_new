...
BASE_FOLDER = "/mfs1/u/chuning/scale_new/outputs/runs/Paper/2026-01-24-03-49_openwebtext2_pythia_adam_cosine_81920PF"
...
TRAIN_THRESHOLD = 81920000000  # 1280 PF in GFLOPs
...
if __name__ == "__main__":
    ...
    # read BASE_FOLDER and TRAIN_THRESHOLD from the args if provided
    import sys
    if len(sys.argv) > 1:
        BASE_FOLDER = sys.argv[1]
    if len(sys.argv) > 2:
        TRAIN_THRESHOLD = int(sys.argv[2])
        SPLIT_CONFIG['train_threshold'] = TRAIN_THRESHOLD
