...
# CHANGE: Added get_cosine_schedule_with_warmup import
...
class CustomTrainer(Trainer):
        ...
        def __init__(self,
            ...
            schedule = []
            # CHANGE: Use .get() for safer access
            for frac, factor in zip(batch_size_scheduler.get('decay_at', []),
                                    batch_size_scheduler.get('B_decay_amt', [])):
        ...
        def create_optimizer_and_scheduler(self,
                ...
                Supports: constant, step, and cosine (with warmup) schedules.
                """
...
def main():
    ...
    args = TrainingArguments(
        ...
        gradient_accumulation_steps=  init_grad_accum,
