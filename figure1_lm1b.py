...
BASE_FOLDER = "/mfs1/u/chuning/scale_new/outputs/runs/ICML/2026-01-28-14-28_lm1b_llama_BFGS_80PF_x6"
...
TRAIN_THRESHOLD = 60000000  # in GFLOPs

# Internal split configuration (test_threshold for isoflop is fixed at 1000PF)
SPLIT_CONFIG = {
    'train_threshold': TRAIN_THRESHOLD,
    'test_threshold': TRAIN_THRESHOLD,
    #1000000000,     # 1000 PF in GFLOPs (fixed for isoflop test)
}
...
def process_owt_dataset(base_folder, split_config, output_prefix):
    ...
    ax_nqs_isoflop.set_title("(b) NQS \n               Model Size", fontsize=FONTSIZE_TITLE, fontweight='bold')
    ...
    ax_nqs_isotoken.set_title("(d) NQS \n               Batch Size", fontsize=FONTSIZE_TITLE, fontweight='bold')
